    ...
    public static class GenerateChipsInterface
    {
        public static string EditorDirectory
        {
            get
            {
                ...
                return Path.Combine(assetDirectory, "Packages", "RRCG", "Editor");
            }
        }

        private static string ChipsPath => Path.Combine(EditorDirectory, "Chips", "Generated", "ChipsGen.cs");
        private static string InterfacePath => Path.Combine(EditorDirectory, "GraphGenerator", "IChips.txt");
